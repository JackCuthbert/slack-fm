  ...
  const schema = Joi.object({
    ...
    activeHours: Joi.object({
      start: Joi.number()
        ...
        .max(23)
        .custom((v, helpers) =>
          v > cfg.activeHours.end ? helpers.error("startafterend") : null
        )
        .required()
        .messages({
        ...
        .max(23)
        .custom((v, helpers) =>
          v < cfg.activeHours.start ? helpers.error("startbeforeend") : null
        )
        .required()
        .messages({
